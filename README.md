The patch demonstrates normalizing time (for exponential and polynomials/ splines shaping) w/ brute-force, which tough for real-time modulation may easily be proper method.
